            ...
            if (opts.destroy == true) {
                ...
                if ($(this).attr("longdesc")) {
                    ...
                    org_image.add(addTrigger).hover(function () {
                        ...
                        if (!parent_border_top) {
                            parent_border_top = 0;
                        }
                        if (!parent_border_left) {
                        ...
                        if (displayFlag == false) {
                            $(icon).css({
                                "top": offset.top + opts.iconOffset + parent_border_top,
                                "left": offset.left + opts.iconOffset + parent_border_left
                            });
                            $("body").prepend(icon);
                        }
                        $(icon).show();
                    ...
                    $(icon).click(function () {
                        ...
                        var full_loading = $("<div></div>").addClass('fullsize-loading').css({
                            "margin-left": loading_left,
                            "margin-top": loading_top
                        });
                        ...
                        $(full_img).load(function () {
                            ...
                            var full_wrap = $("<div></div>").addClass("fullsize-wrapper").css({
                                "display": "none",
                                "margin-top": new_offset.top,
                                "margin-left": new_offset.left
                            });
                            ...
                            if (opts.shadow == true) {
                                if ($.browser.safari || ($.browser.mozilla && $.browser.version.substr(0, 5) >= "1.9.1")) {
                                    ...
                                    var full_sh_wrap = $("<div></div>").addClass("fullsize-sh-wrap").css({
                                        "display": "none",
