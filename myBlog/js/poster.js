;(function ($) {
    ...
    Poster.prototype = {
        settingDOM: function () {
            var srcArr = this.poster.find('img').map(function (i, e) {
                return e.src;
            });
            ...
            ulDOM.parents('.poster-main').append("<div class='poster-btn poster-left-btn'></div>", "<div class='poster-btn poster-right-btn'></div>");
        },
        //是否带有自定义设置
