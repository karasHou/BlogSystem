...
<div id="OSC_Screen">
    <div id="OSC_Content" class="CenterDiv">
        ...
        <div class="MainForm" id="login_page">
            <form id="frm_login" method="get" onsubmit="return false;" style="float:left; width:620px;">
                ...
                <table>
                    ...
                    <tr class="buttons">
                        <th>&nbsp;</th>
                        <td>
                            <input id="btn" value="现在登录" class="BUTTON SUBMIT" type="submit"/>
                        </td>
                    </tr>
                    <tr height="40">
                        <th></th>
