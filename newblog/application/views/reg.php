...
<div id="OSC_Screen">
    <div id="OSC_Content" class="CenterDiv">
        ...
        <div class="MainForm" id="reg_page">
            <!--            这里使用ajax的get方法-->
            <form id="frm_reg" method="get" onsubmit="return false;"
                  style="float:left; width:620px;">
                <h2>申请<span style="color: #006600;"> Blog</span> 账号，已经申请的请点击<a href="User/login">这里</a>登录</h2>
                ...
                <table cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <th>姓名：</th>
                        <td><input name="name" id="f_name" maxlength="20" class="TEXT" style="width: 150px;"
                                   type="text">
                    ...
                    <tr id="tr_area">
                        ...
                        <td><select onchange="showcity(this.value, document.getElementById('userCity'));"
                            ...
                            <script src="assets/js/getcity.js"></script>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <script language="javascript">function _rvi() {
                                    $.get('User/new_code', {}, function (data) {
                                        //或者在这里直接获取整个图片对象，然后整体替换
                                        document.getElementById('code-img').src = 'http://127.0.0.1/BlogSystem/newblog/captcha/' + data + '.jpg';
                    ...
                    <tr class="buttons">
                        ...
                        <td style="padding: 20px 0pt;">
                            <input value=" 注册新用户 " id="btn" class="BUTTON SUBMIT" type="submit">
                        </td>
                    </tr>
                    </tbody>
                </table>
        ...
        <script type="text/javascript">
            ...
            //使用ajax的get方式提交数据，阻止form的提交事件，使用button的click事件替代
            $(function () {
                ...
                $("#f_email").on("blur", function () {
                    ...
                    $.get('User/check_email', {
                        ...
                        if (data == 'already') {
                            $('#error_msg').html("该邮箱已注册").show("fast");
                        } else {
                            $('#error_msg').hide("fast");
                        }
                    }, 'text')
                ...
                $("#f_vcode").on("blur", function () {
                    var code = $(this).val();
                    $.get('User/check_code', {
                        code: code
                    }, function (data) {
                        if (data == 'error') {
                            $('#error_msg').html("验证码输入错误！").show("fast");
                        } else {
                            $('#error_msg').hide("fast");
                        }
                    }, 'text')
